    ...
    return (
      <div className="flex flex-col">
        ...
        <input
          ...
          type={type}
          className={cn(
            "flex h-10 w-full rounded-md shadow-[inset_0_0_0_1px_#CDCDCD] bg-[#FFF] px-3 py-2 transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
